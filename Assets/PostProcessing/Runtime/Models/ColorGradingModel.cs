...
namespace UnityEngine.PostProcessing
{
    ...
    public class ColorGradingModel : PostProcessingModel
    {
        ...
        public struct BasicSettings
        {
			...
			public BasicSettings (float newTint, BasicSettings origin)
			{
				postExposure = origin.postExposure;
				temperature = origin.temperature;
				tint = newTint;
				hueShift = origin.hueShift;
        ...
        public struct Settings
        {
			...
			public Settings (Settings origin, float newTint) 
			{
				tonemapping = origin.tonemapping;
				basic = new BasicSettings(newTint, origin.basic);
				channelMixer = origin.channelMixer;
				colorWheels = origin.colorWheels;
				curves = origin.curves;
